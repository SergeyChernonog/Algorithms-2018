...
abstract class AbstractDynamicTests {
    fun longestCommonSubSequence(longestCommonSubSequence: (String, String) -> String) {
        ...
        //новый тест
        assertEquals("429810023545", longestCommonSubSequence(
                """
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXX-42-XXXXXXXXXXXX-9-8-1-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX-0-0-XXXXXXXX-2-3-5-4-XXXXXXXXXXXXXXXXX
-5-XXXXXXXXXXXXX
              """.trimIndent(),
                """
YYYYYYYYYYYYYYYYYY=42=YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY=9=8=1=YYYY=0=0=YYYYYYYYYYYYYYYYYYYYYY
YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
Y=2=3=5=4=YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY=5=YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
                """.trimIndent()))
        ...
        // у этих строк так же имеется общая подпоследовательность erhlkrw kjk r
        ...
        // у этих строк так же имеется общая подпоследовательность
        /**
         *  дам еса,
         * е в  но,
         * н ве са
...
Наследник всех своих родных.
    ...
    fun shortestPathOnField(shortestPathOnField: (String) -> Int) {
        ...
        //новый тест
        assertEquals(0, shortestPathOnField("input/field_in_large_task.txt"))
